...
class PriceController(object):
    ...
    def __init__(self, asset_price_series):
        self._asset_price_series = asset_price_series
        self._models = self.models_from_price_trajectory(asset_price_series)

    @property
    def asset_price_series(self):
        return self._asset_price_series
    ...
    def models_from_price_trajectory(samples):
        models = dict()
